...
def handle_inputs():
    ...
    parser.add_argument("--fisher-n-all", type=float, default=500, help="how many samples to approximate FI in 'ALL-n=X'")

    parser.add_argument("--randomize-fisher", action='store_true', help="-> Fisher: randomize the FI for each layers")
...
if __name__ == '__main__':
    ...
    names = ["All", "All - n={}".format(args.fisher_n_all), "Sample", "Pred", "True", "True - batch=128"]
    ...
    names = ["None", "All", "All - n={}".format(args.fisher_n_all), "Sample", "Pred", "True", "True - batch=128"]
