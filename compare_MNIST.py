...
description = 'Compare performance of various continual learning methods on chosen scenario using permMNIST/splitMNIST.'
parser = argparse.ArgumentParser('./compare_MNIST.py', description=description)
...
cl_params.add_argument('--XdG', type=float, default=0., dest="xdg",help="XdG: prop neurons per layer to gate")
...
def get_results(args):
    # -get param-stamp
    param_stamp = utils.get_param_stamp_from_args(args)
